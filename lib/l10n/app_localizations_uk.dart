...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get permissionWarning =>
      'Доступ до фотографій не надано. Будь ласка, надайте повний доступ до фотографій, щоб продовжити. Якщо ви раніше відмовили в дозволі, вам може знадобитися ввімкнути його в налаштуваннях вашого пристрою.';
